...
fetch 4 from cursor_product;

fetch 10 from cursor_product;

fetch next from cursor_product;

move backward 10 from cursor_product;
...
begin;
declare
	cursor_product scroll cursor for
		select * from products;
...
move absolute 15 from cursor_product;

fetch from cursor_product;

move absolute 7 from cursor_product;

fetch from cursor_product;

move absolute 2 from cursor_product;
